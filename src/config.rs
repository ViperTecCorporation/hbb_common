...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("SuporteViper".to_owned());
...
pub const RENDEZVOUS_SERVER: &str = match option_env!("RENDEZVOUS_SERVER") {
    Some("") | None => "rs-ny.rustdesk.com",
    Some(server) => server,
};
pub const RENDEZVOUS_SERVERS: &[&str] = &[RENDEZVOUS_SERVER];
pub const RS_PUB_KEY: &str = match option_env!("RS_PUB_KEY") {
    Some("") | None => "OeVuKk5nlHiXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw=",
    Some(key) => key,
};
